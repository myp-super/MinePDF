...
const api: PkmApi = {
  ...
  reorderLibrary: (id, beforeId, afterId = null) => invoke('library:reorder', id, beforeId, afterId),
  ...
  reorderFolder: (id, beforeId, afterId = null) => invoke('folder:reorder', id, beforeId, afterId),
  ...
  getRenderDiag: () => invoke('app:render-diag'),
